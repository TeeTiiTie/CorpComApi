...
using CorpCom_svc.Middlewares;
using CorpCom_svc.Startups;
...
namespace CorpCom_svc
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            PathBannerConfiguration = configuration.GetSection("PathBannerSetting")?.Get<PathBannerSetting>();
        }
        ...
        private PathBannerSetting PathBannerConfiguration { get; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddControllers(options =>
            {
                ...
                {
                    //ReferenceLoopHandling : �ѹ������ dto ��͹ dto;
                    options.SerializerSettings.ReferenceLoopHandling = ReferenceLoopHandling.Ignore;

                    // NullValueHandling : �����ŷ���դ���� null ������ʴ�� response;
            ...
            // Options *
            services.Configure<PathBannerSetting>(Configuration.GetSection("PathBannerSetting"));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStaticFiles(new StaticFileOptions
            {
                FileProvider = new PhysicalFileProvider(
                    Path.GetFullPath(PathBannerConfiguration.StaticPath)),
                RequestPath = PathBannerConfiguration.RequestPath
            });
